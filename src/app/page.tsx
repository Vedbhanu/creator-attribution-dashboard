  ...
  return (
    <div className="max-w-7xl mx-auto space-y-8 py-2">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full text-xs font-extrabold bg-[#4A4FE0] text-white border-2 border-[#111111] shadow-[2px_2px_0px_#111111] mb-3">
