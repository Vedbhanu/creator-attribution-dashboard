...
export default function LandingPage() {
  return (
    <div className="min-h-screen bg-[#FDFCF8] text-[#111111] font-sans selection:bg-[#EC4899] selection:text-white">
      {/* Top Banner */}
      <div className="bg-[#F6D74C] border-b-3 border-[#111111] text-center py-2.5 px-4 font-extrabold text-xs sm:text-sm text-[#111111]">
        ⚡ Stop guessing which content makes money. Turn clicks into tracked revenue.
      </div>
      ...
      <header className="max-w-7xl mx-auto px-6 py-5 flex items-center justify-between border-b-2 border-[#111111]/10">
        <Link href="/" className="flex items-center gap-3">
          ...
          <div>
            ...
            <span className="hidden sm:inline-block ml-2 text-xs font-bold px-2 py-0.5 rounded-full bg-[#4A4FE0] text-white border border-[#111111]">
              By Ved Automation
            </span>
          </div>
        </Link>
      ...
      <section className="max-w-5xl mx-auto px-6 pt-16 pb-12 text-center space-y-8">
        <div className="inline-flex items-center gap-3 px-4 py-2 rounded-full bg-white border-2 border-[#111111] shadow-[3px_3px_0px_#111111]">
          <div className="flex -space-x-2">
            ...
            <span className="w-7 h-7 rounded-full bg-[#4A4FE0] border-2 border-[#111111] text-[10px] font-black text-white flex items-center justify-center">X</span>
            <span className="w-7 h-7 rounded-full bg-[#F6D74C] border-2 border-[#111111] text-[10px] font-black text-[#111111] flex items-center justify-center">NL</span>
          </div>
        ...
        <div className="space-y-3 pt-2">
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            >
              ...
              Book 1-on-1 Systems Audit
            </a>
          </div>

          <div className="flex items-center justify-center gap-4 text-xs font-extrabold text-[#4B4B4B] pt-2">
            <span className="flex items-center gap-1">
              <Check className="w-4 h-4 text-[#EC4899]" /> Turnkey $1,000 Setup
            </span>
            <span>•</span>
            <span className="flex items-center gap-1">
              <Check className="w-4 h-4 text-[#4A4FE0]" /> $30–$50/mo Managed Hosting
            </span>
          </div>
        </div>
          ...
          <Link href="/dashboard" className="block p-3 rounded-3xl bg-white border-3 border-[#111111] shadow-[8px_8px_0px_#111111] overflow-hidden max-w-4xl mx-auto hover:border-[#EC4899] transition-all group">
            ...
            <div className="p-6 bg-[#FDFCF8] text-left space-y-6">
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                <div className="p-4 rounded-xl bg-[#EC4899] text-white border-2 border-[#111111] shadow-[3px_3px_0px_#111111]">
      ...
      <section className="border-t-3 border-[#111111] bg-[#F7F4EC] py-20 px-6">
        <div className="max-w-5xl mx-auto space-y-12 text-center">
          <div className="space-y-3">
            <span className="px-3 py-1 rounded-full bg-[#EC4899] text-white text-xs font-black border-2 border-[#111111] uppercase tracking-wider">
            ...
            <div className="p-8 rounded-3xl bg-white border-3 border-[#111111] shadow-[5px_5px_0px_#111111] space-y-6">
              ...
              <ul className="space-y-4 text-xs font-semibold text-[#4B4B4B]">
                <li className="flex items-start gap-3">
                  ...
                  <span>Google Analytics gives 100 complex charts but zero clarity on revenue.</span>
                </li>
                <li className="flex items-start gap-3">
                  <X className="w-5 h-5 text-rose-500 flex-shrink-0 mt-0.5" />
                ...
                <li className="flex items-start gap-3">
                  <X className="w-5 h-5 text-rose-500 flex-shrink-0 mt-0.5" />
                  <span>Visitors click your bio link today, but buy 2 weeks later—and you lose tracking.</span>
                </li>
              </ul>
            </div>
      ...
      <section className="py-20 px-6 max-w-5xl mx-auto space-y-12 text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-left">
          <div className="p-6 rounded-2xl bg-white border-2.5 border-[#111111] shadow-[4px_4px_0px_#111111] space-y-3">
            ...
            <h3 className="text-lg font-black text-[#111111]">Create Tracking Link</h3>
            <p className="text-xs font-semibold text-[#4B4B4B] leading-relaxed">
              Input your YouTube video URL, X thread, or newsletter post to generate a custom `/r/[slug]` link.
            </p>
          </div>
          ...
          <div className="p-6 rounded-2xl bg-white border-2.5 border-[#111111] shadow-[4px_4px_0px_#111111] space-y-3">
            ...
            <h3 className="text-lg font-black text-[#111111]">Capture Leads & Clicks</h3>
            <p className="text-xs font-semibold text-[#4B4B4B] leading-relaxed">
              Visitors click your link and submit their email via our hosted `/c/[slug]` opt-in form or your landing page.
            </p>
          </div>

          <div className="p-6 rounded-2xl bg-[#EC4899] text-white border-2.5 border-[#111111] shadow-[4px_4px_0px_#111111] space-y-3">
            <div className="w-10 h-10 rounded-xl bg-white text-[#111111] border-2 border-[#111111] flex items-center justify-center font-black text-base">
              3
            </div>
            <h3 className="text-lg font-black text-white">Attribute Sales & Revenue</h3>
            <p className="text-xs font-bold text-white leading-relaxed">
              Record sales conversions and see exact dollar amounts ($) mapped back to each content item!
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="border-t-3 border-[#111111] bg-[#F6D74C] py-20 px-6">
        <div className="max-w-4xl mx-auto p-10 rounded-3xl bg-white border-3 border-[#111111] shadow-[8px_8px_0px_#111111] text-center space-y-8">
          <div className="space-y-3">
            <span className="px-4 py-1.5 rounded-full bg-[#EC4899] text-white text-xs font-black border-2 border-[#111111] uppercase tracking-wider">
              Turnkey Managed Setup Offer
            </span>
            <h2 className="text-3xl sm:text-4xl font-black text-[#111111]">
          ...
          <div className="p-6 rounded-2xl bg-[#F7F4EC] border-2 border-[#111111] max-w-md mx-auto space-y-4">
            <div className="space-y-1">
              ...
              <div className="text-xs font-bold text-[#EC4899]">+ $30–$50 / month managed hosting & support</div>
            </div>

            <ul className="text-xs font-bold text-[#111111] space-y-2 text-left pt-2 border-t border-[#111111]/20">
              <li className="flex items-center gap-2"><Check className="w-4 h-4 text-[#EC4899]" /> 100% Turnkey Setup & Supabase Database</li>
              <li className="flex items-center gap-2"><Check className="w-4 h-4 text-[#4A4FE0]" /> Unlimited Content Tracking Links</li>
              <li className="flex items-center gap-2"><Check className="w-4 h-4 text-[#EC4899]" /> Hosted Public Lead Pages & API</li>
          ...
          <div className="pt-2">
            ...
            >
              <span>Book Your Free Systems Audit Call →</span>
            </a>
          </div>
        </div>
      </section>
